...
# import numpy as np # all pacage needed..
...
#     fit = UMAP( n_neighbors=n_neighbors, min_dist=min_dist,
#                 n_components=n_components, metric=metric, random_state=rstate,  densmap=dens,)# verbose=True,
